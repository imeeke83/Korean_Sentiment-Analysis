...
public class ParseTreeNode
{
	...
	public void traverse(int depth, String relation, StringBuffer sb)
	{
		...
		sb.append(id + "\t" + this.eojeol + Util.LINE_SEPARATOR);
	...
	{
		if( eojeol != null ) return eojeol.containsTagOf(tagNum);
		return false;
	}
	...
	{
		if( eojeol != null ) return eojeol.isLastMorpOf(null, tagNum);
		return false;
	}
	...
	{
		if( eojeol != null ) return eojeol.isLastMorpOf(morp, tagNum);
		return false;
	}
	...
	{
		if( eojeol != null ) return eojeol.getFirstMorp().isTagOf(tagNum);
		return false;
	}
	...
	{
		if( eojeol != null ) {
			Morpheme mp = eojeol.getFirstMorp();
